...
public class PrintExpressionType {
    ...
    static class TypeCalculatorVisitor extends VoidVisitorAdapter<JavaParserFacade> {
        ...
        public void visit(ReturnStmt n, JavaParserFacade javaParserFacade) {
            ...
            //System.out.println(n.getExpr().toString() + " has type " + javaParserFacade.solvegetType(n.getExpr()));
        }
    ...
    public static void main(String[] args) throws FileNotFoundException, ParseException {
        TypeSolver typeSolver = new CombinedTypeSolver(new ReflectionTypeSolver(), new JavaParserTypeSolver(new File("D:/git/EHMetrics/EHMetrics/src")));

        CompilationUnit agendaCu = JavaParser.parse(new FileInputStream(new File("D:/git/EHMetrics/EHMetrics/src/ufrn/dimap/lets/ehmetrics/test/Agenda.java")));
